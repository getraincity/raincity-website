...
/**
 * The WhatsApp mark, beside the phone number wherever the number is shown
 * (client request, 2026-09-25: the number opens WhatsApp).
 *
 * THE ONE ICON NOT IN THE SITE'S COLOURS, on purpose. Like the partner logos,
 * it is another company's mark and is recognised by its colour: the monochrome
 * glyph in currentColor was tried and read as a generic chat bubble at 16px,
 * and WhatsApp green alone went faint on the RainCity Blue header strip. So it
 * is WhatsApp's own solid form — a green bubble with a white handset — which
 * holds on blue, navy and white alike. #25D366 is WhatsApp's brand green and
 * appears nowhere else; it is not a palette token and must not become one.
 *
 * Paths from Simple Icons (CC0): the bubble's outer contour filled green,
 * then the full glyph in white, scaled into it.
 */
const whatsappGlyph =
...
const whatsappBubble =
  "M20.52 3.449A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z";
...
export function WhatsApp({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d={whatsappBubble} fill="#25D366" />
      <path d={whatsappGlyph} fill="#fff" transform="translate(3.4 3.4) scale(.72)" />
    </svg>
  );
}
